            ...
            <div class="row position-relative">
                ...
                <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="our-story">
                        <h4>Since 2024</h4>
                        <h3>Our Story</h3>
                        <p>Founded in 2024, People-Plus Management Solutions is a management consultancy firm dedicated
                            to the provision of professional, relevant, responsive and creative solutions to help
                            organisations and individuals to achieve their goals. Based in Ndola, People-Plus has a team
                            of dedicated professionals, supported by a network of associate Consultants based on the
                            Copperbelt and Lusaka Provinces of Zambia, and also in South Africa. We are passionate about
                            providing relevant management Solutions, with a special focus on labour law, human capital,
                            tax, personal finance, higher education management, Information technology and information
                            systems.</p>
                    </div>
                </div>
            </div>
    ...
    <section id="skills" class="skills section">
        ...
        <div class="container section-title" data-aos="fade-up">
            ...
            <h2 class="mt-4">Core Values</h2>
                <li><strong>Fortitude:</strong> There is a solution to every management challenge. We'll
                    help you find yours.
                </li>
                <li><strong>Adaptability:</strong> Making necessary changes without compromising quality and
                    our values
                </li>
                <li><strong>Innovation:</strong> Improve operations, meet customer needs, and drive business
                    growth
                </li>
                <li><strong>Team-Work:</strong> Valuing people and their input is an integral component of
                    success
                </li>
